...
DIR_SAIDA       <- file.path(RAIZ, "TESTE/3_ANALISE_DE_GRUPOS/outputs_figuras/capital_vs_interior")
...
N_ESCOLAS_POR_GRUPO <- NULL    # ex: 20 pega as 20 mais extremas de cada area
...
tabela <- dados_cluster |>
  ...
  select(ID_ESCOLA, AREA, TIPO_ESCOLA, LOCALIZACAO, CLUSTER,
