...
DIR_SAIDA       <- file.path(RAIZ, "TESTE/3_ANALISE_DE_GRUPOS/outputs/figuras/publica_vs_particular")
...
tabela <- dados_cluster |>
  ...
  select(ID_ESCOLA, TIPO_NORM, AREA, LOCALIZACAO, AREA_LOCAL, CLUSTER,
